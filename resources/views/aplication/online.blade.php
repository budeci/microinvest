...
@section('content')
    <div class="container">
        <div class="main bg-white">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="{{route('app_online_post')}}" method="POST" id="form-aplication-dealer" class="form-aplication-dealer" enctype="multipart/form-data">
...
<div class="col-md-2 form-group">
    ...
    <input value="{{ old('app.creditTerm') }}" name="app[creditTerm]" type="number" class="js-term form-control" placeholder="max. 36 luni" required min="3" max="36">
                ...
                <span class="btn btn-success btn-block" style="font-size: 13px;">Limită de creditare</span>
                        ...
                        <input name="app[loanPurposeRows][0][clientContribution]" type="hidden" value="">
