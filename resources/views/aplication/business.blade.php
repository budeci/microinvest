...
@section('content')
    <div class="container">
        <div class="main bg-white">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="{{route('app_business_post')}}" method="POST" id="form-aplication-dealer" class="form-aplication-dealer" enctype="multipart/form-data">
...
<div class="col-md-2 form-group">
    ...
    <input value="{{ old('app.creditTerm') }}" name="app[creditTerm]" type="number" class="js-term form-control" placeholder="max. 36 luni" required min="3" max="36">
                        ...
                        <input name="app[applicationType]" type="hidden" value="2">
