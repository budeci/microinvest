        ...
        <div class="main bg-white">
            ...
            <div class="row" id="payment-schedule-response">
                ...
                <div class="col js-schendule-success" style="display: none;">
                    <legend>Plata lunară:</legend>
                    <div class="js-schendule table-responsive schendule schendulev2">
                ...
                <div class="col-md-12">
                    <form action="{{route('app_standart_post')}}" method="POST" id="form-aplication-dealer" class="form-aplication-dealer" enctype="multipart/form-data">
                        <div class="row js-calc-payment">
                            <div class="col-md-12">
                                <legend>Calculați rata lunară</legend>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <button data-action="{{route('getPaymentSchedule')}}" type="button" class="js-btn-calc-payment btn btn-success btn-calc" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Procesare">Calculați rata lunară</button>
                                </div>
                            </div>
                           <!--  <div class="col">
                               <div class="form-group">
    ...
    <input value="{{ old('app.creditTerm') }}" name="app[creditTerm]" type="number" class="js-term form-control" placeholder="max. 36 luni" required min="3" max="36">
                ...
                <span class="btn btn-success btn-block" style="font-size: 13px;">Limită de creditare</span>
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <span class="help-block small text-danger" style="font-size: 9px;"><em>Limită de creditare</em></span>
                            </div>
                        </div>
